...
public class PrimedNuke extends Entity {
    ...
    private static final net.minecraft.world.entity.EntityType<? extends PrimedNuke> EntityType = null;
    @Nullable
    ...
    protected void explode() {
        float f = 128000.0F;
        this.level.explode(this, this.getX(), this.getY(0.0625D), this.getZ(), 128000.0F, Explosion.BlockInteraction.BREAK);
    }
